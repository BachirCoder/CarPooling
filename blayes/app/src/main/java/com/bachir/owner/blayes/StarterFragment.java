...
public class StarterFragment extends Fragment implements View.OnClickListener {
    ...
    OnRoleSelectedListener mCallback;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        driver = (Button) getView().findViewById(R.id.btn1);
        passenger = (Button) getView().findViewById(R.id.btn2);
    ...
    public void onClick(View v) {
        ...
        if (v == driver) {
            mCallback.isDriver(v);
        }

        if (v == passenger) {
            mCallback.isPassenger(v);
